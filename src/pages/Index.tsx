...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-4 px-4 md:px-6 dark:bg-gradient-to-b dark:from-[#1A1F2C] dark:via-[#221F26] dark:to-[#0D1117] light:from-[#f0f9ff] light:via-[#e0f2fe] light:to-[#dbeafe]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-4 animate-fadeIn">
          <h1 className="text-3xl md:text-4xl font-bold mb-1 text-[#B86A87]">stockchat</h1>
          <p className="text-foreground/80 text-sm">Search for a stock to analyze sentiment, news, and performance</p>
        </div>
        ...
        {!searchedSymbol ? (
          ...
          <div className="flex items-center justify-between mb-3 animate-fadeIn">
            <div className="flex items-center gap-2">
              <span className="text-xl font-bold text-[#9747FF]">{searchedSymbol}</span>
              <Button 
                variant="ghost" 
                size="icon" 
                onClick={clearSearch} 
        ...
        {!searchedSymbol && (
          <div className="text-center pt-2 pb-4 animate-fadeIn relative">
            ...
            <div className="relative">
              ...
              <h2 className="text-xl md:text-2xl font-bold mb-3 text-[#B86A87]">Enter a Stock Symbol to Begin</h2>
              
              <div className="max-w-md mx-auto p-4 glass-card rounded-2xl mb-4">
              ...
              <div className="flex flex-wrap justify-center gap-2 mt-3">
                <div className="flex items-center gap-1 p-2 bg-[#B86A87]/10 dark:bg-[#B86A87]/20 rounded-lg text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#B86A87]" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M12 7a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0V8.414l-4.293 4.293a1 1 0 01-1.414 0L8 10.414l-4.293 4.293a1 1 0 01-1.414-1.414l5-5a1 1 0 011.414 0L11 10.586 14.586 7H12z" clipRule="evenodd" />
                  </svg>
                  <span className="font-medium">Stock Performance</span>
                </div>
                <div className="flex items-center gap-1 p-2 bg-[#9747FF]/10 dark:bg-[#9747FF]/20 rounded-lg text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#9747FF]" viewBox="0 0 20 20" fill="currentColor">
