    ...
    <div className="min-h-screen bg-background text-foreground py-4 px-4 md:px-6 dark:bg-gradient-to-b dark:from-[#1A1F2C] dark:via-[#221F26] dark:to-[#0D1117] light:from-[#f0f9ff] light:via-[#e0f2fe] light:to-[#dbeafe]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-4 animate-fadeIn">
          <h1 className="text-3xl md:text-4xl font-bold mb-1 bg-gradient-to-r from-[#F97316] to-[#8B5CF6] bg-clip-text text-transparent">stockchat</h1>
        ...
        {!searchedSymbol && (
          <div className="text-center pt-2 pb-4 animate-fadeIn relative">
            ...
            <div className="relative">
              ...
              <h2 className="text-xl md:text-2xl font-bold mb-3 text-foreground bg-gradient-to-r from-[#F97316]/90 to-[#8B5CF6]/90 bg-clip-text text-transparent">Enter a Stock Symbol to Begin</h2>
              ...
              <div className="flex flex-wrap justify-center gap-2 mt-3">
                <div className="flex items-center gap-1 p-2 bg-[#F97316]/10 dark:bg-[#F97316]/20 rounded-lg text-sm">
                ...
                <div className="flex items-center gap-1 p-2 bg-[#8B5CF6]/10 dark:bg-[#8B5CF6]/20 rounded-lg text-sm">
